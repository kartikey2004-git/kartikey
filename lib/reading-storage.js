...
export const WIDTH_CLASS = {
  ...
  normal: "max-w-none",
  // Matches the AppShell/blog-page focus-mode ceiling (max-w-5xl) exactly,
  // so "wide" is a no-op unless focus mode has actually widened the outer
  // container, and never exceeds it when focus mode is on.
