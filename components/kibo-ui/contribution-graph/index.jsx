...
const fillHoles = (activities) => {
  ...
  // Get the year from the first activity to start from January 1st
...
export const ContributionGraphFooter = ({ className, ...props }) => (
  <div
    className={cn(
...
export const ContributionGraphLegend = ({ className, children, ...props }) => {
          ...
          <svg height={blockSize} key={level} width={blockSize}>
            ...
            <rect
              className={cn(
                ...
                'dark:data-[level="0"]:fill-[#161b22] dark:data-[level="1"]:fill-[#0e4429] dark:data-[level="2"]:fill-[#006d32] dark:data-[level="3"]:fill-[#26a641] dark:data-[level="4"]:fill-[#39d353] data-[level="0"]:fill-[#ebedf0] data-[level="1"]:fill-[#9be9a8] data-[level="2"]:fill-[#40c463] data-[level="3"]:fill-[#30a14e] data-[level="4"]:fill-[#216e39]',
              )}
              data-level={level}
              height={blockSize}
              rx={blockRadius}
