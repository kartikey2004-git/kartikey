...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto md:py-1 px-4 w-full  left-0 top-0">
      ...
      <p className="text-gray-400 mb-6 max-w-3xl text-sm sm:text-base md:text-lg leading-snug text-left">
        My projects are powered by modern frameworks and tools that make
        development faster, scalable, and more enjoyable.
      </p>
    </div>
  );
};
