...
const roles = [
  ...
  },
  {
    ...
    points: [
      "Built the website for Elixir Community.",
...
const About = () => {
  ...
  return (
    ...
    >
      {/* Glow Background */}
      <div className="fixed top-0 left-0 w-full h-full z-[-1] opacity-40 pointer-events-none">
        <div className="absolute w-96 h-96 rounded-full blur-3xl" />
      </div>

      {/* Glass Container */}
      <div className="backdrop-blur-xl rounded-3xl p-6 md:p-12 shadow-xl relative overflow-hidden">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-10">
            <h1
              className={cn(
                parisienne.variable,
                "text-3xl md:text-4xl font-semibold text-black dark:text-white"
              )}
            >
              Little About Me
            </h1>
            ...
            {roles.map((role, idx) => (
              <div key={idx}>
                <h2 className="text-xl md:text-2xl flex items-center gap-3 font-semibold text-black dark:text-white">
                  <SiCodesignal className="text-2xl md:text-3xl animate-pulse" />
                  {role.title}
                </h2>
                <p className="text-sm md:text-base mt-1 text-black dark:text-white">
                  {role.duration}
                </p>
          ...
          {/* Visual Card */}
          <div className="relative w-full h-72 md:h-[450px] rounded-2xl overflow-hidden shadow-2xl group">
            <div className="w-full h-full bg-cover bg-center rounded-2xl transition-all duration-300 relative">
              {/* Background Image */}
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-all duration-300 rounded-2xl z-10" />
              ...
              <div className="absolute bottom-0 left-0 w-full p-4 z-20">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-sm text-gray-200 mt-1">
                    Featuring  Dev : Passionate about building real-world projects, leading tech communities, and exploring full-stack innovations.
                  </p>
                </div>
              </div>
            </div>
