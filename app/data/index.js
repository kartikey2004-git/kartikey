...
export const projects = [
  ...
  },
  {
    ...
    features: [
      ...
      "Visual canvas for diagrams and whiteboarding.",
      "Publish markdown as SEO-optimized blog posts.",
      "Integrated task planner with calendar view.",
      "Authentication with email/password and Google OAuth.",
      "Drag & drop image uploads in markdown.",
      "Dark/light theme with smooth UI experience.",
      "Unified workspace for writing, planning, and ideation.",
    ],
    bg: "markstack",
